...
public:
  ...
  virtual bool canMoveTo(Position, Farm);  // mengembalikan true jika animal bisa move ke position di dalam Farm
  ...
  virtual std::string interactProduct() = 0; // mengembalikan hasil dari interact dengan animal
